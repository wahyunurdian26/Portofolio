            ...
            <div class="main-content-inner">
                ...
                <div class="row mt-5 mb-5">
                                    ...
                                    <div class="data-tables datatable-dark">
                                         ...
                                         <th>No</th>
                                            ...
                                            if(isset($_POST['search'])){
                                                 $tgl1=$_POST['tgl1'];
                                                 $tgl2=$_POST['tgl2'];
											$brg=mysqli_query($conn,"SELECT * from sbrg_masuk sb, sstock_brg st where st.idx=sb.idx AND tgl BETWEEN '$tgl1' AND '$tgl2' order by sb.id DESC");
											$no=1;
                    ...
                    <?php   if(isset($_POST['search'])){
                                  ?>
                    <a href="../exportbrgmsk.php?T1=<?php echo base64_encode($tgl1).'&T2='.base64_encode($tgl2); ?>" id=btn target="_blank" class="btn btn-info">Export Data</a>
                   <?php } ?>             
                </div>
